    ...
    <div class="booking-panel">
        ...
        <div class="booking-panel-section booking-panel-section4">
            ...
            <div class="booking-form-container">
                <form action="verify_seat.php" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="11-9">Nov 9,2023</option>
                        <option value="11-10">Nov 10,2023</option>
                        <option value="11-11">Nov 11,2023</option>
                        <option value="11-12">Nov 12,2023</option>
                        <option value="11-13">Nov 13,2023</option>
                    </select>
                    ...
                    <input placeholder="Phone Number" type="number" name="pNumber" min="99999" max="99999999999999" required>
