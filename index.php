    ...
    <div id="home-section-3" class="trailers-section">
        ...
        <div class="trailers-grid">
            <div class="trailers-grid-item">
                ...
                <div class="trailer-item-info" data-video="KudedLV0tP0">
            ...
            <div class="trailers-grid-item">
                ...
                <div class="trailer-item-info" data-video="wS_qbDztgVY">
                    <h3>Marvel Studios' The Marvels </h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>
            <div class="trailers-grid-item">
                <img src="img/movie-thumb-3.jpg" alt="">
                <div class="trailer-item-info" data-video="RDE6Uz73A7g">
                    <h3>The Hunger Games: The Ballad Of Songbirds And Snak...</h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>
            <div class="trailers-grid-item">
                <img src="img/movie-thumb-4.jpg" alt="">
                <div class="trailer-item-info" data-video="EP34Yoxs3FQ">
            ...
            <div class="trailers-grid-item">
                ...
                <div class="trailer-item-info" data-video="qZ40Z62tcXM">
            ...
            <div class="trailers-grid-item">
                ...
                <div class="trailer-item-info" data-video="pQmibwnatGQ">
                    <h3>The Bridge Curse 2: Ritual</h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>
        </div>
